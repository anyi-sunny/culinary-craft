...
/**
 * The "About the Developer" tab: the origin story sits beside the portrait
 * (stacking under it on mobile), and the software-engineer story runs
 * full-width below. Both cards grow with however much text they hold.
 */
